...
<div class="container">
    ...
    <ul class="pager">
        ...
        <a class="btn btn-default" href="${pageContext.request.contextPath}/admin/getBoardList?currentPage=1">첫페이지로</a>
        ...
        <a class="btn btn-default" href="${pageContext.request.contextPath}/admin/getBoardList?currentPage=${lastPage}">마지막 페이지로</a>
    </ul>
    <div>
